...
#as a single comment indicator, to be replaced with just (//) and not (#//) or (//#). Fill in the 
#parameters of the substitution method to complete this function: 
...
#(3 digits followed by a dash, 3 more digits followed by a dash, and 4 digits), and converts it to a more 
#formal format that looks like this: (XXX) XXX-XXXX. Fill in the regular expression to complete this 
#function.
